    ...
    <view class="content">
		...
		<view class="card-tips">
			<view class="card-tips-item">
				<text>* 钻石代理每天能发布2条头条文章</text>
			</view>
			<view class="card-tips-item">
				<text>* 普通会员每天能发布1条头条文章</text>
			</view>
		</view>
		<view class="card-fixed">
			<navigator class="card-fixed-item" hover-class="none" url="../putnews/putnews">
				<view class="card-fixed-con linearyellow">发布我的微头条</view>
			</navigator>
